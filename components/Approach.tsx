  ...
  My <span className="text-purple">Tech Stacks</span>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="My Frontend work Life started with ReactJS 2 years ago and have been using this stack as the sole in Professional life due to company regulations but NextJS has been my go to for personal projects and have done a lot of work on it."
        >
          <CanvasRevealEffect
            animationSpeed={3}
